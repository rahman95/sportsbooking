                    ...
                    @else
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{{ url('/home') }}"><i class="fa fa-btn fa-cogs"></i>Dashboard</a></li>
                                <li><a href="{{ url('/myaccount') }}"><i class="fa fa-btn fa-user"></i>My Account</a></li>
                                <li><a href="{{ url('/mybookings') }}"><i class="fa fa-btn fa-calendar-o"></i>My Bookings</a></li>
